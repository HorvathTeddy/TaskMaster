            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ alignSelf: "center" }}>
                    <View style={styles.profileImage}>
                        <Image source={require("../../assets/selfie.jpg")} style={styles.image} resizeMode="center"></Image>
                    </View>
                ...
                <View style={styles.infoContainer}>
                    ...
                    <Text style={[styles.text, { color: "#AEB5BC", fontSize: 14 }]}>Company Role: Company Name</Text>
                </View>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <View style={[styles.statsBox, { borderColor: "#DFD8C8", borderLeftWidth: 1, borderRightWidth: 1 }]}>
                        ...
                        <Text style={[styles.text, styles.subText]}>Completed Tasks</Text>
                    </View>
                    <View style={styles.statsBox}>
                        <Text style={[styles.text, { fontSize: 24 }]}>3</Text>
                        <Text style={[styles.text, styles.subText]}>Current Tasks</Text>
                    </View>
                </View>
